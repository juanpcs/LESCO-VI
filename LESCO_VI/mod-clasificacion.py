...
y_train = to_categorical(y_train.astype(int), num_classes=24)
y_test = to_categorical(y_test.astype(int), num_classes=24)
...
cnn_model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(24, activation='softmax')  # Capa de densa de salida
